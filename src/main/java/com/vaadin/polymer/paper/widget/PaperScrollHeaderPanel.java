...
public class PaperScrollHeaderPanel extends PolymerWidget {
     ...
     *
     * JavaScript Info:
     * @property HEADER_STATE_CONDESED
     * @type number
     * 
     */
    public double getHEADER_STATE_CONDESED(){
        return getPolymerElement().getHEADER_STATE_CONDESED();
    }
    /**
     * <p>The header’s state when it’s condensed.</p>
     *
     ...
     * 
     */
    public void setHEADER_STATE_CONDESED(double value) {
        getPolymerElement().setHEADER_STATE_CONDESED(value);
    }
    ...
    /**
     * <p>The state of the header. The initial value is <code>HEADER_STATE_EXPANDED</code>.<br>Depending on the configuration and the <code>scrollTop</code> value,<br>the header state could change to<br><code>HEADER_STATE_HIDDEN</code>, <code>HEADER_STATE_CONDESED</code> and <code>HEADER_STATE_INTERPOLATED</code></p>
     *
     * JavaScript Info:
